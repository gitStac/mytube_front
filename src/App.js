  ...
  return (
    <div className={storeInfo.theme}>
      ...
      <Routes>
        ...
        <Route
          path="/account"
          element={storeInfo.isLogin ? <Account /> : <SignIn />}
        />
        <Route
          path="/channel"
          element={storeInfo.isLogin ? <Channels /> : <SignIn />}
        />
        <Route
          path="/subscription"
          element={storeInfo.isLogin ? <Subscription /> : <SignIn />}
        />
        <Route
          path="/signin"
          element={!storeInfo.isLogin ? <SignIn /> : <Home />}
        />
        <Route
          path="/signup"
          element={!storeInfo.isLogin ? <SignUp /> : <Home />}
        />
        <Route
          path="/videosec"
          element={storeInfo.isLogin ? <SelectChannel /> : <SignIn />}
        />
        <Route
          path="/upload"
          element={storeInfo.isLogin ? <Upload /> : <SignIn />}
        />
      </Routes>
    </div>
  );
